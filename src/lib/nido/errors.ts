...
const USER_MESSAGES: Record<NidoErrorCode, string> = {
  ...
  last_owner: "No puedes salir siendo el único propietario del Nido. Transfiere la propiedad a otro miembro primero.",
  cannot_transfer_to_self: "No puedes transferirte la propiedad a ti mismo.",
  invalid_transfer_target: "Solo puedes transferir la propiedad a un miembro activo de este Nido.",
  cannot_remove_self: "No puedes eliminarte a ti mismo. Usa Salir del Nido.",
  invalid_remove_target: "Solo puedes eliminar a un miembro activo de este Nido.",
  ...
  invalid_visibility: "Elige si tus datos personales son visibles al Nido o solo tuyos.",
  invalid_date: "La fecha no es válida.",
  expense_not_found: "No encontramos este gasto.",
  expense_deleted: "Este gasto ya fue eliminado.",
  expense_has_refunds: "Este gasto ya tiene devoluciones. No se puede editar.",
...
const MESSAGE_CODES: Record<string, NidoErrorCode> = {
  ...
  "nido.cannot_transfer_to_self": "cannot_transfer_to_self",
  "nido.invalid_transfer_target": "invalid_transfer_target",
  "nido.cannot_remove_self": "cannot_remove_self",
  "nido.invalid_remove_target": "invalid_remove_target",
