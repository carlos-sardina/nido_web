...
- Category create / rename / archive (`create_category`, `rename_category`, `archive_category`) for **expense** categories. Income catalog is Sueldo + Extra. No hard delete. No client `household_id`.
